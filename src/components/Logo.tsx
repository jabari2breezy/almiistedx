    ...
    return (
      <div className={`flex flex-col ${className}`}>
        ...
        <div className="flex flex-col -mt-1">
          <span className="font-sans font-medium text-[10px] md:text-[12px] uppercase tracking-widest text-brand-primary">AlMuntazir School</span>
          <span className="font-sans font-light text-[8px] md:text-[9px] uppercase tracking-[0.4em] text-brand-primary/60">Youth</span>
          <span className="font-typewriter text-[7px] uppercase tracking-[0.2em] text-brand-primary/30 mt-1">independently organized event</span>
        </div>
      </div>
    );
  }
